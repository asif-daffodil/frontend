                ...
                <div className="container py-5">
                        ...
                        <div className="col-md-6">
                            <form action="" method="post" onSubmit={handleSubmit(onSubmit)}>
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="firstName" defaultValue={auth?.user[0]?.firstName} {...register('firstName', {
                                        required: {
                                            value: true,
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="lastName" defaultValue={auth?.user[0]?.lastName} {...register('lastName', {
                                        required: {
                                            value: true,
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="row">
                                            ...
                                            <select className="form-select" id="month" {...register('month', {
                                                ...
                                                <option value="">Month</option>
                                                {
                                                    monthName.map((month, index) => {
                                                        return (
                                                            <option value={month} key={index + 1} selected={month === auth?.user[0]?.month ? true : false}>{month}</option>
                                                        );
                                                    })
                                                }
                                            </select>
                                        ...
                                        <div className="col-md-4">
                                            <input type="text" className="form-control" placeholder='Day' id="day" name="day" defaultValue={auth?.user[0]?.day} {...register('day', {
                                                required: {
                                                    value: true,
                                            ...
                                            {errors.day && <span className="text-danger">{errors.day.message}</span>}
                                        </div>
                                        <div className="col-md-4">
                                            <input type="text" className="form-control" placeholder='Year' id="year" name="year" defaultValue={auth?.user[0]?.year} {...register('year', {
                                                required: {
                                                    value: true,
                    ...
                    <div className="row">
                        <div className="col-md-12 text-bg-primary h5 py-2">
                            Answer the questions below to find out which application is best for you.
                        </div>
                        <PreApplication />
                    </div >
                </div >
